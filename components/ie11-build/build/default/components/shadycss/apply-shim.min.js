(function () {
  ...
  */
  ...
  function y(a, b) {
    ...
    a.parent && (c = b.substring(a.previous ? a.previous.end : a.parent.start, a.start - 1), c = ca(c), c = c.replace(z, " "), c = c.substring(c.lastIndexOf(";") + 1), c = a.parsedSelector = a.selector = c.trim(), a.atRule = 0 === c.indexOf("@"), a.atRule ? 0 === c.indexOf("@media") ? a.type = A : c.match(da) && (a.type = B, a.keyframesName = a.selector.split(z).pop()) : a.type = 0 === c.indexOf("--") ? C : D);
  ...
  function S(a, b, c) {
    for (var e; e = H.exec(b);) {
      ...
      if (m) {
        ...
        for (d in q) {
          k = h && h[d], m = [d, ": var(", f, "_-_", d], k && m.push(",", k.replace(O, "")), m.push(")"), O.test(q[d]) && m.push(" !important"), n.push(m.join(""));
        }
      }
  ...
  function T(a, b, c) {
    ...
    for (var e, d, f = {}, g = 0, h; g < b.length; g++) {
      if (e = b[g]) if (h = e.split(":"), 1 < h.length) {
        e = h[0].trim();
        d = h.slice(1).join(":");
  ...
  function ta(a) {
    ...
    a._validating || (a._validating = !0, qa.then(function () {
  ...
  W.prototype.styleElement = function (a) {
    ...
    if (!(b && "" !== N(b) || !b || sa(b))) {
      if (sa(b) || b._applyShimValidatingVersion !== b._applyShimNextVersion) this.prepareTemplate(b, c), ta(b);
